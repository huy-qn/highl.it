...
},{}],"dxBca":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "40fc74a2db1e7347";
...
},{}],"32WI6":[function(require,module,exports) {
//@ts-ignore
...
const isSelection = (input)=>{
    return input.addRange !== undefined;
};
window.onload = function() {
    if (rangy) {
        ...
        highlighter.addClassApplier(rangy.createClassApplier("highlight", {
            ...
            elementProperties: {
                ...
                onclick: function() {
                    ...
                    if (window.confirm("Delete this note (ID " + highlight.id + ")?")) highlighter.removeHighlights([
                        highlight
                    ]);
                    return false;
                }
        ...
        window.addEventListener('mouseup', (event)=>{
            ...
            if (isSelection(sel)) {
                if (sel.focusOffset !== sel.anchorOffset) {
                    ...
                    if (!urlMap[urlHash]) urlMap[urlHash] = '';
        ...
        if (savedUrlMap) highlighter.deserialize(savedUrlMap);
    }
};

},{}]},["kn9T2","dxBca","32WI6"], "32WI6", "parcelRequired307")
